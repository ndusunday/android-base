...
fun <T> Observable<T>.applyNewScheduler() = applyScheduler(Schedulers.newThread())
...
fun <T> Flowable<T>.applyNewScheduler() = applyScheduler(Schedulers.newThread())
...
fun <T> Single<T>.applyNewScheduler() = applyScheduler(Schedulers.newThread())
...
fun <T> Maybe<T>.applyNewScheduler() = applyScheduler(Schedulers.newThread())
